...
<head>
    <meta charset="UTF-8">
    <?php $title = "Федюшкин Никита, группа 231-362, Лабораторная работа №3"; ?>
     ...
     <form>
       ...
       <label for="email">Email:</label>
        ...
        <p>Откуда узнали о нас:</p>
           <input type="radio" id="social_media" name="source" value="social_media">
        ...
        <textarea id="message" name="message" rows="6" cols="40" required></textarea><br>
